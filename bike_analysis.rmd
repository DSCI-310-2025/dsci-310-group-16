...
Bike-sharing systems are a growing component of urban design (Winters, 2020), providing an eco-friendly, convenient, and healthy alternative to traditional transient or driving. Building understanding around the factors that drive bike-share demand can help urban designers improve bike services. The dataset we used to form our regression is the Bike Sharing Dataset (dataset ID: 275) from the UCI Machine Learning Repository, which you can find at <https://archive.ics.uci.edu/dataset/275/bike+sharing+dataset>. It contains information on bike rentals, weather, and time-related features. Our research question: How do environmental and temporal factors affect bike-sharing demand?
